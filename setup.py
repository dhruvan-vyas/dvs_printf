...
from dvs_printf import LoadingBar, ShowLoading, showLoading
# print("\n--- Running LoadingBar Class Demo (Deterministic Progress Bar) ---")
...
# loader = LoadingBar(
#     title_text="Processing heavy matrix computations...", 
#     bar_color=["cyan", "magenta"],
#     timing_color="yellow",
#     timeout=10
# )
