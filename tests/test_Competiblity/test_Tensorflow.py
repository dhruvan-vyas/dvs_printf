...
try:
    ...
    def test_arrayToList_tf():
        assert list(list_of_str((tf_list,)))==[
    ...
    def test_getmat_true_tf():
        assert list(list_of_str((tf_list,),getmat= True ))==test_tf_list
        assert list(list_of_str((tf_list,),getmat="true"))==test_tf_list

    def test_getmat_show_tf():
        assert list(list_of_str((tf_list,),getmat="true show info"))==test_tf_list + \
