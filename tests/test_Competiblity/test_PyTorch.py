...
try:
    ...
    def test_arrayToList_pt():
        assert list(list_of_str((pt_list,),))==[
    ...
    def test_getmat_true_pt():
        assert list(list_of_str((pt_list,),getmat= True ))==test_pt_list
        assert list(list_of_str((pt_list,),getmat="true"))==test_pt_list

    def test_getmat_show_pt():
        assert list(list_of_str((pt_list,),getmat="true show info"))==test_pt_list + \
