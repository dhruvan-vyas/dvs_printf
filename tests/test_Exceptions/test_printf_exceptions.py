...
if console_EnvType == 1:
    error_massages = {
        "style": '\x1b[38;2;155;82;199mStyleNameError\x1b[0m: The Style \x1b[38;2;110;118;129m\'none\'\x1b[0m Is Not Recognized. Please check the available styles.',
    ...
    error_massages = {
        'style': '\x1b[38;5;140mStyleNameError\x1b[0m: The Style \x1b[38;5;103m\'none\'\x1b[0m Is Not Recognized. Please check the available styles.',
    ...
    error_massages = {
        'style': '\x1b[94mStyleNameError\x1b[0m: The Style \x1b[90m\'none\'\x1b[0m Is Not Recognized. Please check the available styles.',
        ...
        'style': 'StyleNameError\x1b[0m: The Style \'none\'\x1b[0m Is Not Recognized. Please check the available styles.',
...
def test_printf_keyword_style_fuzzy_suggestion():
    try:   printf("hello world", style="typign")
    except Exception as E: 
        assert "Did you mean:" in str(E)
        assert '"typing"' in str(E)
