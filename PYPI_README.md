...
| :--- | :--- | :--- |
| **`printf()`** | Core animation rendering engine, line streaming, matrix formatting. | [📖 `printf` Documentation Guide](https://github.com/dhruvan-vyas/dvs_printf/blob/main/READMES/printf_README.md) |
| **`Init` / `init`** | Global configuration management, theme presets, singleton instance. | [📖 `Init` Documentation Guide](https://github.com/dhruvan-vyas/dvs_printf/blob/main/READMES/init_README.md) |
| **`colors`** | 24-bit TrueColor engine, 2D angular gradients, 345+ color dictionary, presets. | [📖 `colors` Documentation Guide](https://github.com/dhruvan-vyas/dvs_printf/blob/main/READMES/colors_README.md) |
| **`loaders`** | Multi-threaded `LoadingBar`, `Spinner`, `ShowLoading`, `ShowSpinner`, `ProgressUpdater`. | [📖 `loaders` Documentation Guide](https://github.com/dhruvan-vyas/dvs_printf/blob/main/READMES/loaders_README.md) |
| **`exceptions`** | AST frame inspection, token highlighting pointers, fuzzy typo matcher. | [📖 `exceptions` Documentation Guide](https://github.com/dhruvan-vyas/dvs_printf/blob/main/READMES/exceptions_README.md) |
| **`list_of_str()`** | Multi-type matrix and complex data structure string generator. | [📖 `list_of_str` Documentation Guide](https://github.com/dhruvan-vyas/dvs_printf/blob/main/READMES/list_of_str_README.md) |
...
### 1. [`printf` Function Core Engine](https://github.com/dhruvan-vyas/dvs_printf/blob/main/READMES/printf_README.md)
...
👉 *For complete parameter details and architecture breakdown, read the [printf Documentation Guide](https://github.com/dhruvan-vyas/dvs_printf/blob/main/READMES/printf_README.md).*

---

### 2. [`Init` / `init` Global Configuration Manager](https://github.com/dhruvan-vyas/dvs_printf/blob/main/READMES/init_README.md)
...
👉 *For singleton mechanics and property setter details, read the [Init Documentation Guide](https://github.com/dhruvan-vyas/dvs_printf/blob/main/READMES/init_README.md).*


---

### 3. [`colors` Engine (`Colors`, `GradientStyles`, Named Colors)](https://github.com/dhruvan-vyas/dvs_printf/blob/main/READMES/colors_README.md)
...
👉 *For conversion functions (`name_to_rgb`, `name_to_256`) and color lists, read the [colors Documentation Guide](https://github.com/dhruvan-vyas/dvs_printf/blob/main/READMES/colors_README.md).*

---

### 4. [`loaders` Module (`LoadingBar`, `Spinner`, `showLoading`, `showSpinner`)](https://github.com/dhruvan-vyas/dvs_printf/blob/main/READMES/loaders_README.md)
...
👉 *For full parameter tables and code examples, read the [loaders Documentation Guide](https://github.com/dhruvan-vyas/dvs_printf/blob/main/READMES/loaders_README.md).*

---

### 5. [`exceptions` Module & AST Visualizer](https://github.com/dhruvan-vyas/dvs_printf/blob/main/READMES/exceptions_README.md)
...
👉 *For excepthook registration details and error dictionary rules, read the [exceptions Documentation Guide](https://github.com/dhruvan-vyas/dvs_printf/blob/main/READMES/exceptions_README.md).*

---

### 6. [`list_of_str` Function](https://github.com/dhruvan-vyas/dvs_printf/blob/main/READMES/list_of_str_README.md)
...
👉 *For matrix serialization rules and code examples, read the [list_of_str Documentation Guide](https://github.com/dhruvan-vyas/dvs_printf/blob/main/READMES/list_of_str_README.md).*
...
- **Detailed Module Documentation:** [`READMES/` Directory](https://github.com/dhruvan-vyas/dvs_printf/tree/main/READMES)
- **Issue & Bug Tracker:** [GitHub Issues](https://github.com/dhruvan-vyas/dvs_printf/issues)
- **Release History:** [RELEASE_NOTES.md](https://github.com/dhruvan-vyas/dvs_printf/blob/main/RELEASE_NOTES.md) | [CHANGELOG.md](https://github.com/dhruvan-vyas/dvs_printf/blob/main/CHANGELOG.md)
- **Contribution Guidelines:** [CONTRIBUTING.md](https://github.com/dhruvan-vyas/dvs_printf/blob/main/docs/CONTRIBUTING.md)
- **Code of Conduct:** [CODE_OF_CONDUCT.md](https://github.com/dhruvan-vyas/dvs_printf/blob/main/docs/CODE_OF_CONDUCT.md)
- **Code Audit & Benchmark Report:** [DEEP_CODE_AUDIT_REPORT.md](https://github.com/dhruvan-vyas/dvs_printf/blob/main/docs/DEEP_CODE_AUDIT_REPORT.md)

### License
Distributed under the **Apache License 2.0**. See the [LICENSE](https://github.com/dhruvan-vyas/dvs_printf/blob/main/LICENSE) file for full legal terms.
